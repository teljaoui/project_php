    ...
    <section id="featured" class="my-5  pb-5">
        ...
        <div class="filter container">
            <div class="col-12 mb-5 d-flex justify-content-between">
                ...
                <div class="item filter-colapse" onclick="showprice()">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
        ...
        <div class="show-price">
            <div class="container aside-bar">
                <i class="fa-solid fa-x" onclick="closeprice()"></i>
                <div class="sidebar-nav">
                    <h5 class="mt-3">Search Products</h5>
                    <hr class="mx-0 mb-3">
                    <form action="shop.php" method="post">
                        <div class="container-fluid">
                            ...
                            <div class="form-group my-2">
                                <input type="submit" value="Search" name="search_price" class="btn btn-primary">
                            </div>
                        </form>
